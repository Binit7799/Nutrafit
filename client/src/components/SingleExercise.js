...
import { getCardioById, getResistanceById, deleteCardio, deleteResistance,getUserFormsById, deleteUserFormsById } from '../utils/API';
...
export default function SingleExercise() {
    ...
    const [userFormsData, setUserFormsData] = useState({})
