...
export const createUserForms = (userFormData, token) => {
  return fetch("/api/exercise/userForms", {
    method: "POST",
    headers: {
      'Content-Type': 'application/json',
      authorization: `Bearer ${token}`,
...
export const getUserFormsById = (userFormId, token) => {
  return fetch(`/api/exercise/userForms/${userFormId}`, {
    headers: {
      'Content-Type': 'application/json',
      authorization: `Bearer ${token}`,
    }
...
export const deleteUserFormsById = (userFormId, token) => {
  return fetch(`/api/exercise/userForms/${userFormId}`, {
    method: "DELETE",
    headers: {
      authorization: `Bearer ${token}`,
